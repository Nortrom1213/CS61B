...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Queue<Item>>
        ...
        for (Item item : items) {
            Queue<Item> onequeue = new Queue<>();
            onequeue.enqueue(item);
            queues.enqueue(onequeue);
        }
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        while (sortedQueues.size() > 1) {
            Queue<Item> q1 = sortedQueues.dequeue();
            Queue<Item> q2 = sortedQueues.dequeue();

            sortedQueues.enqueue(mergeSortedQueues(q1, q2));
        }
